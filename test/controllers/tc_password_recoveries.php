...
class TcPasswordRecoveries extends TcBase {
	...
	function test_create_new(){
		...
		$this->assertStringContains('Have you forgotten your password?',$ctrl->mailer->body);
		...
		$this->assertStringContains("This user account has been deactivated. Password recovery process can not be started.",$client->getContent());
